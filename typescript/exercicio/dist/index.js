function sendSpaceship(name, captain) {
    ...
    alert("A nave ".concat(spaceship.name, " comanda pelo capit\u00E3o ").concat(spaceship.captain, " foi enviada em uma miss\u00E3o!"));
    return spaceship;
}
...
var speed = Number(prompt('Insira a velocidade para a qual deseja que a nave voe.'));
